...
\title{Horizon-Gated JEPA: Label-Free Separation of Slow and Fast Factors in Time Series}

\author{\IEEEauthorblockN{Jaechan Lee}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\% TODO: fill in department
\textit{name of organization (of Aff.)}\\% TODO: fill in institution
City, Country \\% TODO
Student ID: 21261919}
}
