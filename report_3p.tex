...
\textbf{Slow} $=$ diagnosis (constant over the record --- a harder,
partially \emph{static}-content case we flag as such), \textbf{fast} $=$
beat-level waveform value.
...
\emph{Absolute} probe scores only; RankMe \cite{garrido2023rankme} monitors
