...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.72\textwidth]{figs/fig_embed_exclusion.png}
\caption{The exclusion term, seen directly: a t-SNE of $\zslow$ coloured by the transient factor, with the mechanism and without it (synthetic $\pm$3\%, HGLP-NCE, $\lambda=4$, one seed). This is the only one of the three terms that differs between the two models --- inclusion is \numFigInclusion{} against \numFigNoInclusion{} and allocation \numFigAllocation{} against \numFigNoAllocation. All six panels are in Fig.~\ref{fig:embed_full}.}
\label{fig:embed}
\end{figure}
